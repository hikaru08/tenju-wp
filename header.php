...
<html>
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-W8KJE39FRJ"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-W8KJE39FRJ');
  </script>
  <?php wp_head(); ?>
...
<img alt="フリーコール" src="<?php echo get_template_directory_uri()?>/images/freecall.png" />
<p>0120-920-678</p>
